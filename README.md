...
-O z -o $src/vcf/$parameterO.vcf.gz
 ...
 ## Filter VCF file and extract SNP data
 
 
 
 ## Make files for D3 portal
 
 ## Submit sequence data to the D3 portal for SNP design and generate a quote.
